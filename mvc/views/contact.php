...
<!-- Mirrored from max-themes.net/demos/hotale/hotale/resort/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 10:36:59 GMT -->
<head>
    <meta charset="UTF-8" />
...
<body
                ...
                <div class="hotale-logo hotale-item-pdlr">
                    <div class="hotale-logo-inner">
                        ...
                        <a class="hotale-orig-logo" href="index.html">
                            <img src="upload/logo-nx2-1.png" alt="" width="294" height="74" title="logo-nx2" />
                        </a>
                    </div>
                </div>
        ...
        <div class="hotale-body-wrapper clearfix hotale-with-transparent-header hotale-with-frame">
            ...
            <div class="hotale-page-wrapper" id="hotale-page-wrapper">
                <div class="gdlr-core-page-builder-body">
                    <div class="gdlr-core-pbf-wrapper" style="padding: 300px 0px 160px 0px;" data-skin="white" id="gdlr-core-wrapper-1">
                        <div class="gdlr-core-pbf-background-wrap" style="background-color: #0a0a0a;">
                            <div
                                ...
                                style="background-image: url(../../../../../demo.goodlayers.com/hotale/resort/wp-content/uploads/sites/2/2022/02/page-title-bg-2.jpg); background-size: cover; background-position: center;"
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                                        <div class="gdlr-core-title-item-title-wrap">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title class-test" style="font-size: 75px; font-weight: 600; letter-spacing: 0px; text-transform: none; color: #ffffff;">
                                                Contact Us<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                            </h3>
                                        </div>
                                        <span class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 25px; font-style: normal; letter-spacing: 0px; color: #e5e5e5; margin-top: 15px;">
                                            Get Intouch
                                        </span>
                                    </div>
                                </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                    <div class="gdlr-core-text-box-item-content" style="font-weight: 700; text-transform: none;">
                                                        <p><a style="text-decoration: underline;" href="#">+1-2345-2345</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-contact-form-7-item gdlr-core-item-pdlr gdlr-core-item-pdb">
                                                    <div role="form" class="wpcf7" id="wpcf7-f1979-p1964-o1" lang="en-US" dir="ltr">
                                                        ...
                                                        <form method="post" action="https://max-themes.net/demos/hotale/hotale/resort/contactform/contactengine.php">
    ...
    <script type="text/javascript" src="js/plugins/goodlayers-core/plugins/scripta732.js?ver=1653819908" id="gdlr-core-plugin-js"></script>
...
<!-- Mirrored from max-themes.net/demos/hotale/hotale/resort/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 10:37:00 GMT -->
</html>
